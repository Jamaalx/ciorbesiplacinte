// src/app/(dashboard)/worker/documente-hr/page.tsx
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800">Documente HR</h1>
      </div>
      ...
      <div className="rounded-lg bg-white p-6 shadow">
        <div className="mb-4 flex items-center">
          ...
          <span className="ml-2 text-sm text-gray-600">
            Aici găsești toate documentele HR disponibile pentru tine. Documentele sunt confidențiale.
          </span>
        </div>

        {documents.length === 0 ? (
          <div className="rounded-lg border border-dashed border-gray-300 p-6 text-center">
            <p className="text-gray-500">Nu există documente HR disponibile momentan.</p>
          </div>
        ) : (
